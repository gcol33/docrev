...
import { readImageRegistry } from './build.js';
 ...
 */
function protectImages(md, registry = null) {
  const images = [];
 ...
 */
function matchWordImagesToOriginal(originalImages, wordImages, registry = null) {
 ...
 * @returns {string}
 */
function restoreTables(text, tables) {
