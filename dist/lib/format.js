...
export function table(headers, rows, options = {}) {
    const { align = headers.map(() => 'left'), // 'left', 'right', 'center'
    headerStyle = chalk.bold.cyan, borderStyle = chalk.dim, cellStyle = null, // function(value, colIndex, rowIndex) => styled string
     } = options;
...
export function box(content, options = {}) {
    const { title = null, padding = 1, borderStyle = chalk.dim, titleStyle = chalk.bold.cyan, } = options;
