...
export declare let quietMode: boolean;
export declare let jsonMode: boolean;
...
export declare function findFiles(ext: string, cwd?: string): string[];
...
export { getTemplate, listTemplates, generateCustomTemplate, } from '../templates.js';
export { getUserName, setUserName, getConfigPath, getDefaultSections, setDefaultSections, loadUserConfig, saveUserConfig, } from '../config.js';
export { inlineDiffPreview } from '../format.js';
export { countWords } from '../utils.js';
export { parseCommentsWithReplies, collectComments, generateResponseLetter, groupByReviewer, } from '../response.js';
export { validateCitations, getCitationStats, } from '../citations.js';
export { extractEquations, getEquationStats, createEquationsDoc, extractEquationsFromWord, getWordEquationStats, } from '../equations.js';
export { parseBibEntries, checkBibDois, fetchBibtex, addToBib, isValidDoiFormat, lookupDoi, lookupMissingDois, } from '../doi.js';
export { clearDoiCache, getDoiCacheStats, } from '../doi-cache.js';
